// Guards for the owner-run HC PQRA v4.0 lifestage direct-contact promotion tool
// (promote-hc-pqra-lifestage.mjs). Plain ASCII only.
// Mirrors promote-hc-pqra-adult.test.mjs re-scoped to the 6 HC PQRA lifestage-receptor records
// (infant / child / teen body weight + total-body skin surface area).
...
import {
  ...
  planPromotion,
  applyPromotion,
} from '../promote-hc-pqra-lifestage.mjs';
...
const BASE_VALUE_FIXTURES = [
  // 0: pv-hc-pqra-v4-2024-bw-infant-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-bw-infant-ca',
    ...
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 infant body weight. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E body weight (infant, 8.2 kg).',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      locator: 'Appendix E, infant column',
      value_text: 'infant: 8.2 kg',
      extraction_method: 'manual_source_extraction',
      extracted_by: 'claude-fable-5',
      extracted_at: '2026-06-12',
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-bw-infant-ca-1',
  ...
  // 1: pv-hc-pqra-v4-2024-bw-child-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-bw-child-ca',
    substance_key: 'generic',
    pathway: 'human-health-direct',
    input_key: 'BW_kg',
    value: 32.9,
    ...
    jurisdiction: 'general',
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 child body weight. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E body weight (child, 32.9 kg).',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-bw-child-ca-1',
    }],
    source_relationships: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      role: 'canonical_candidate',
  ...
  // 2: pv-hc-pqra-v4-2024-bw-teen-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-bw-teen-ca',
    substance_key: 'generic',
    pathway: 'human-health-direct',
    input_key: 'BW_kg',
    value: 59.7,
    ...
    jurisdiction: 'general',
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 teen body weight. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E body weight (teen, 59.7 kg).',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-bw-teen-ca-1',
    }],
    source_relationships: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      role: 'canonical_candidate',
  ...
  // 3: pv-hc-pqra-v4-2024-sa-total-infant-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-sa-total-infant-ca',
    substance_key: 'generic',
    pathway: 'human-health-direct',
    input_key: 'SA_cm2',
    value: 3620,
    ...
    jurisdiction: 'general',
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 infant total-body skin surface area. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E infant SA 3620 cm2.',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-sa-total-infant-ca-1',
    }],
    source_relationships: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      role: 'canonical_candidate',
  ...
  // 4: pv-hc-pqra-v4-2024-sa-total-child-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-sa-total-child-ca',
    substance_key: 'generic',
    pathway: 'human-health-direct',
    input_key: 'SA_cm2',
    value: 10140,
    ...
    jurisdiction: 'general',
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 child total-body skin surface area. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E child SA 10140 cm2.',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-sa-total-child-ca-1',
    }],
    source_relationships: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      role: 'canonical_candidate',
  ...
  // 5: pv-hc-pqra-v4-2024-sa-total-teen-ca
  {
    parameter_value_id: 'pv-hc-pqra-v4-2024-sa-total-teen-ca',
    substance_key: 'generic',
    pathway: 'human-health-direct',
    input_key: 'SA_cm2',
    value: 15470,
    ...
    jurisdiction: 'general',
    source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID],
    applicability: 'HC PQRA v4.0 teen total-body skin surface area. needs_review candidate.',
    uncertainty: 'Pending direct-source verification.',
    review_notes: 'HC PQRA v4.0 Appendix E teen SA 15470 cm2.',
    evidence_items: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      qa_status: 'needs_review',
      evidence_id: 'ev-pv-hc-pqra-v4-2024-sa-total-teen-ca-1',
    }],
    source_relationships: [{
      source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID,
      role: 'canonical_candidate',
...
// Build a full fixture with all 6 value records + 1 untouched extra + the source.
function makeFixture(valueOverrides = {}, sourceOverrides = {}) {
  // Clone all 6 base fixtures, apply per-id overrides if provided.
...
// Build a valueOverrides map where all 6 records are in the done state.
...
describe('promote-hc-pqra-lifestage: scope constants', () => {
  it('exports exactly 6 value IDs', () => {
    expect(HC_PQRA_LIFESTAGE_PROMOTION_VALUE_IDS).toHaveLength(6);
  });
  it('lists the correct value IDs in order', () => {
    expect(HC_PQRA_LIFESTAGE_PROMOTION_VALUE_IDS).toEqual([
  ...
  it('targets the correct source', () => {
    expect(HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID).toBe('src-health-canada-pqra-v4-2024');
  });
});

describe('promote-hc-pqra-lifestage: parseArgs', () => {
  it('parses flags and values', () => {
    const a = parseArgs(['node', 's', '--reviewer', 'J. Nelson', '--date', '2026-06-20',
      '--source-url', 'https://canada.ca/x', '--zotero-key', 'SFH7ARKQ', '--apply']);
    expect(a).toMatchObject({
      reviewer: 'J. Nelson', date: '2026-06-20', sourceUrl: 'https://canada.ca/x',
...
describe('promote-hc-pqra-lifestage: validateApplyOptions', () => {
...
describe('promote-hc-pqra-lifestage: planPromotion -- happy path', () => {
  it('plans all 6 values to promote + source (absent canonical_source_status = promotable)', () => {
...
describe('promote-hc-pqra-lifestage: planPromotion -- fail-closed preconditions', () => {
  ...
  it('throws on identity mismatch (wrong jurisdiction)', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-sa-total-teen-ca': { jurisdiction: 'BC' },
    });
    expect(() => planPromotion(records, sources, APPLY_OPTS)).toThrow(/expected frame-eligible identity/);
  });
  it('throws on identity mismatch (wrong unit)', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-sa-total-child-ca': { unit: 'm2' },
    });
    expect(() => planPromotion(records, sources, APPLY_OPTS)).toThrow(/expected frame-eligible identity/);
  });
  it('throws when source_ids does not match the HC PQRA source', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-bw-infant-ca': { source_ids: ['src-wrong'] },
    });
  ...
  it('throws when source_ids has a second linked source (under-block risk)', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-bw-infant-ca': { source_ids: [HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID, 'src-extra'] },
    });
    expect(() => planPromotion(records, sources, APPLY_OPTS)).toThrow(/source_ids must be EXACTLY/);
  });
  it('throws on a drifted pre-state (qa_status superseded)', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-sa-total-teen-ca': { qa_status: 'superseded' },
    });
  ...
  it('throws when the source role is policy_compilation', () => {
    ...
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-bw-infant-ca': {
        source_relationships: [{ source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID, role: 'policy_compilation' }],
      },
    });
  ...
  it('throws when a source_relationships role is reference_mining', () => {
    const { records, sources } = makeFixture({
      'pv-hc-pqra-v4-2024-bw-child-ca': {
        source_relationships: [{ source_id: HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID, role: 'reference_mining' }],
      },
    });
    expect(() => planPromotion(records, sources, APPLY_OPTS)).toThrow(/policy_compilation\/reference_mining/);
  });
  ...
  it('throws when the source record is missing', () => {
    const { records, sources } = makeFixture();
    const filteredSrc = sources.filter((s) => s.source_id !== HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID);
  ...
  it('throws when evidence_items[0].source_id is a stale foreign reference (nested-source guard)', () => {
    const target = HC_PQRA_LIFESTAGE_PROMOTION_VALUE_IDS[0];
...
describe('promote-hc-pqra-lifestage: idempotency', () => {
  ...
  it('on a locator-only re-run with all done, returns sourceTouched=true and updates the url', () => {
    ...
    const s = sources.find((x) => x.source_id === HC_PQRA_LIFESTAGE_PROMOTION_SOURCE_ID);
    expect(s.url).toBe('https://canada.ca/real.pdf');
  });
});

describe('promote-hc-pqra-lifestage: field edits on each of the 6 value records', () => {
  it('flips qa + evidence + adds attestation on all 6 records', () => {
    const { records, sources } = makeFixture();
    applyPromotion(records, sources, APPLY_OPTS);
    for (const valueId of HC_PQRA_LIFESTAGE_PROMOTION_VALUE_IDS) {
  ...
  it('stamps provenance fields on all 6 records on fresh promotion', () => {
    const { records, sources } = makeFixture();
    applyPromotion(records, sources, APPLY_OPTS);
    for (const valueId of HC_PQRA_LIFESTAGE_PROMOTION_VALUE_IDS) {
      const r = records.find((x) => x.parameter_value_id === valueId);
  ...
  it('repairs a missing provenance stamp on an already-approved record (valueTouched=true)', () => {
    ...
    for (const base of BASE_VALUE_FIXTURES) {
      doneOverrides[base.parameter_value_id] = {
        ...
        uncertainty: base.uncertainty + ' [PROMOTED to approved on 2026-06-20 by J. Nelson]',
        review_notes: base.review_notes + ' [PROMOTED to approved on 2026-06-20 by J. Nelson]',
      };
    }
    const { records, sources } = makeFixture(doneOverrides, { canonical_source_status: 'direct_source_verified' });
    const applied = applyPromotion(records, sources, APPLY_OPTS);
