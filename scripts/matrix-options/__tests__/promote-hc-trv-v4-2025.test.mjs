...
describe('promote-hc-trv-v4-2025: scope constants', () => {
  it('exports exactly 88 value IDs', () => {
    expect(HC_TRV_V4_2025_PROMOTION_VALUE_IDS).toHaveLength(88);
  });
...
describe('promote-hc-trv-v4-2025: planPromotion -- happy path', () => {
  it('plans all 88 values to promote + skips the already-verified source', () => {
    const { records, sources } = makeFixture();
    const plan = planPromotion(records, sources, APPLY_OPTS);
    expect(plan.valueResults).toHaveLength(88);
