...
// ---------------------------------------------------------------------------
// Types (shared across BenchmarkDataViewer and ReferenceDataBrowser)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// TrainingDataTable Component
// ---------------------------------------------------------------------------

interface TrainingDataTableProps {
  data: TrainingData;
  /** Extra content rendered at the top of the sidebar (e.g. back button, pack name) */
  sidebarHeader?: ReactNode;
}

export function TrainingDataTable({ data, sidebarHeader }: TrainingDataTableProps) {
