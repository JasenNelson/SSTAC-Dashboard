            ...
            filteredDocuments.map((doc: Document) => (
              <li key={doc.id}>
                <Link
                  ...
                  className="block px-6 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                >
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 ml-4 flex-shrink-0">
