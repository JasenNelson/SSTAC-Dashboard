      ...
      <div className="relative">
        ...
        <div className="space-y-3">
          {milestones.map((milestone, _index) => (
            <div
              key={milestone.id}
              className="relative flex items-start group cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 rounded-lg"
