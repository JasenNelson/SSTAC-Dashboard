    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-6">
      ...
      <div className="space-y-3">
        {announcements.map((announcement) => (
             ...
             className={`p-4 rounded-lg border cursor-pointer transition-all duration-200 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-1 ${
             ...
             onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); toggleAnnouncement(announcement.id); } }}
           >
