              ...
              return (
                <g key={index}>
                  <path
                    ...
                    className={`transition-all duration-300 ${interactive ? 'cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500' : ''}`}
          ...
          <div className="mt-6 space-y-2">
            {slices.map((slice, index) => (
              <div
                ...
                } ${selectedSlice === index ? 'bg-sky-50 border border-sky-200' : ''} ${interactive ? 'cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:-outline-offset-2' : ''}`}
                onMouseEnter={() => handleSliceHover(index)}
                onMouseLeave={() => handleSliceHover(null)}
                onClick={() => handleSliceClick(index)}
                role={interactive ? "button" : undefined}
