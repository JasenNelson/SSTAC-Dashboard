    ...
    <div className={`relative ${className}`}>
      ...
      {showShareMenu && (
        <>
          ...
          {/* Menu */}
          <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-200 dark:border-slate-700 z-50" role="menu">
            <div className="p-2">
              ...
              <button
                ...
                role="menuitem"
              >
                <svg className="w-5 h-5 mr-3 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <button
                ...
                role="menuitem"
              >
                <svg className="w-5 h-5 mr-3 text-sky-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
