      ...
      {showDetails && likes > 0 && (
        <div 
          ...
          <div className="p-3 border-b border-slate-100 dark:border-slate-700">
            <h4 className="font-medium text-slate-900 dark:text-white">Liked by</h4>
          </div>
          <div className="max-h-48 overflow-y-auto">
            {likeDetails.map((like) => (
              <div key={like.id} className="flex items-center justify-between p-3 hover:bg-slate-50 dark:hover:bg-slate-700">
