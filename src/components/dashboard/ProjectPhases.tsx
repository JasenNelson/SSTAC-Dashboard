      ...
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <button 
                    ...
                    className="flex items-center space-x-2 text-slate-600 dark:text-slate-300 text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
            ...
            {/* Scoping Plan */}
            <div className="flex items-start space-x-3 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors">
              <span className="flex-shrink-0 w-6 h-6 bg-blue-500 text-white text-xs font-bold rounded-full flex items-center justify-center">
                2
              </span>
