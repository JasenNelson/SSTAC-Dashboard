                ...
                <div className="flex space-x-2">
                  {presetColors.map((color) => (
                    <button
                      ...
                      className="w-6 h-6 rounded border-2 border-slate-300 hover:border-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-1"
