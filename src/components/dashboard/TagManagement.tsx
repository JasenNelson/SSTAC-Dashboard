                ...
                <div className="flex space-x-2">
                  {presetColors.map((color) => (
                    <button
                      ...
                      className="w-6 h-6 rounded border-2 border-slate-300 hover:border-slate-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-sky-500"
