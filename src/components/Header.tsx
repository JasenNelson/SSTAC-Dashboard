    ...
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {session && (
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative ml-4" data-desktop-menu>
                ...
                {isDesktopMenuOpen && (
                  <div id="desktop-menu" className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 dark:ring-slate-600 z-50">
        ...
        {session && isMobileMenuOpen && (
          <div id="mobile-menu" className="md:hidden border-t border-slate-200 dark:border-slate-700 py-4">
