    ...
    <div className="relative">
      ...
      <div className="border-t border-slate-200 dark:border-slate-700">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-2 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors text-sm"
        >
