...
describe('SUBSTANCE_LIBRARY -- Phase 1a metal-salts + organometallics own-key oral wiring (2026-07-04)', () => {
  ...
  const expected = [
    ...
    { key: 'calcium_cyanide', rfd: 0.001, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'copper_cyanide', rfd: 0.005, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'cyanide_free', rfd: 0.00063, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'hydrogen_cyanide_and_cyanide_salts', rfd: 0.0006, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'potassium_cyanide', rfd: 0.002, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'potassium_silver_cyanide', rfd: 0.005, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'silver_cyanide', rfd: 0.1, sf: null, cls: 'inorganic', absDermal: 0.1 },
    { key: 'sodium_cyanide', rfd: 0.001, sf: null, cls: 'inorganic', absDermal: 0.1 },
