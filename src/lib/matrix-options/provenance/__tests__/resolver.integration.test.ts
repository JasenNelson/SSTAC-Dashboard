...
describe('resolveProvenanceRows -- Phase 1a metal-salts + organometallics SOURCED (2026-07-04)', () => {
  ...
  const cases: Array<{ substance: string; value: number; pvid: string; jurisdiction: string }> = [
    ...
    { substance: 'calcium_cyanide', value: 0.001, pvid: 'pv-iris-calcium_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'copper_cyanide', value: 0.005, pvid: 'pv-iris-copper_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'cyanide_free', value: 0.00063, pvid: 'pv-iris-cyanide_free-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'hydrogen_cyanide_and_cyanide_salts', value: 0.0006, pvid: 'pv-iris-hydrogen_cyanide_and_cyanide_salts-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'potassium_cyanide', value: 0.002, pvid: 'pv-iris-potassium_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'potassium_silver_cyanide', value: 0.005, pvid: 'pv-iris-potassium_silver_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'silver_cyanide', value: 0.1, pvid: 'pv-iris-silver_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
    { substance: 'sodium_cyanide', value: 0.001, pvid: 'pv-iris-sodium_cyanide-hh-direct-rfd', jurisdiction: 'US_federal' },
...
describe('resolveProvenanceRows -- Phase 2 batch A3 SOURCED (2026-07-04)', () => {
  // chlorobenzene = HC-default (SOURCED to Canada_federal; 2026-07-06 correction -- see below);
  // dichlorobenzene_1_2 = HC-default (SOURCED to Canada_federal); trichloroethylene =
  // most-protective IRIS override (SOURCED to US_federal). Each value uniquely matches its approved row.
  // 2026-07-06 CORRECTION: chlorobenzene's current_default moved from the interim EPA/IRIS row (0.02)
  // to the HC v4.0 row (0.43) -- PR #513 (2026-07-05) picked EPA believing HC's value was a
  // mis-attribution, which was disproven by direct verification against the real HC v4.0 source PDF.
...
describe('resolveProvenanceRows -- current_default selections (2026-07-05)', () => {
  const cases = [
    { substance: 'chlorobenzene', input: 'rfd_oral_mg_per_kg_bw_day', unit: 'mg/kg-bw/day', value: 0.43, pvid: 'pv-hc-chlorobenzene-hh-direct-rfd' },
