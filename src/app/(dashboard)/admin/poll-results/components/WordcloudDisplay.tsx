        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-inner">
          ...
          <div style={{ height: '400px', width: '100%' }}>
            {selectedPoll.wordcloud_words.every(
              ...
              >
                <Suspense fallback={<div className="flex items-center justify-center h-full text-slate-500">Loading wordcloud...</div>}>
                  <CustomWordCloud
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow">
          ...
          <div className="max-h-64 overflow-y-auto">
            {selectedPoll.wordcloud_words.map((word, index) => (
              <div
                key={index}
                className="flex items-center justify-between px-4 py-2 border-b border-slate-200 dark:border-slate-700 last:border-b-0"
              >
