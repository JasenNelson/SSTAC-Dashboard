    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-slate-200 dark:border-slate-600">
            ...
            <div className="mb-8">
              ...
              {/* Chart J-1 */}
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg shadow p-6 mb-6">
                <ReportBarChart
                  data={j1Data}
        ...
        <section className="mb-16">
          ...
          {/* Introduction */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-slate-200 dark:border-slate-600 mb-6">
            <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
              <p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-slate-200 dark:border-slate-600 mb-6">
            ...
            <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 space-y-4">
              <h4 className="text-lg font-semibold text-slate-900 dark:text-white">The Good:</h4>
              <p>
              ...
              <h4 className="text-lg font-semibold text-slate-900 dark:text-white">The Bad:</h4>
              <p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-slate-200 dark:border-slate-600 mb-6">
            ...
            <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 space-y-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4 my-4">
                <p>
