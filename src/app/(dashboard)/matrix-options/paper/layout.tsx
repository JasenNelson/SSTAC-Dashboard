...
export default function MatrixOptionsPaperLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-slate-100 dark:bg-slate-900">
      <header className="sticky top-0 z-30 flex items-center gap-4 border-b border-slate-200 bg-white px-4 py-2 shadow-sm dark:border-slate-700 dark:bg-slate-800 print:hidden">
