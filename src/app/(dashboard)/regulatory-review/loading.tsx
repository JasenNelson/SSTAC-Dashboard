    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6 animate-pulse">
      ...
      <div className="space-y-3 mb-4">
        <div className="flex items-center">
          <div className="h-4 w-4 bg-slate-200 dark:bg-slate-700 rounded mr-2" />
      ...
      <div className="bg-white dark:bg-slate-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse">
              <div className="h-6 w-6" />
            </div>
            <div>
              <div className="h-6 w-64 bg-slate-200 dark:bg-slate-700 rounded mb-2 animate-pulse" />
