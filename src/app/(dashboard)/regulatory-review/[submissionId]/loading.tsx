...
function SidebarSkeleton() {
  return (
    <div className="w-[280px] bg-white border-r border-slate-200 p-4 animate-pulse">
      {/* Header */}
  ...
  return (
    <div className="flex-1 p-6 animate-pulse">
      ...
      <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
        {/* Table Header Row */}
        <div className="grid grid-cols-6 gap-4 p-4 border-b border-slate-200 bg-slate-50">
        ...
        {/* Table Rows */}
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="grid grid-cols-6 gap-4 p-4 border-b border-slate-200">
            <div className="h-4 w-16 bg-slate-200 rounded" />
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-3">
            ...
            <div className="h-4 w-4 bg-slate-200 rounded mx-2 animate-pulse" />
