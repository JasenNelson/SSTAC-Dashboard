  ...
  return (
    <div
      className={`
        ...
        ${isExpanded
          ? 'border-sky-400 dark:border-sky-500 shadow-md'
          : hasSelection
            ? 'border-sky-300 dark:border-sky-600 bg-sky-50/50 dark:bg-sky-900/20'
      ...
      >
        <div
          className={`
            ...
            ${isExpanded || hasSelection ? 'bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-300' : 'bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400'}
          `}
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1">{stage.description}</p>
        </div>
        <div className="flex items-center gap-2 flex-shrink-0">
          {hasSelection && (
            <span className="text-xs font-medium text-sky-600 dark:text-sky-300 bg-sky-100 dark:bg-sky-900/30 px-2 py-1 rounded-full">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected
                    ? 'bg-sky-100 dark:bg-sky-900/30 ring-1 ring-sky-300 dark:ring-sky-600'
              ...
              >
                ...
                <div
                  className={`
                    ...
                    ${isSelected ? 'border-sky-500 bg-sky-500' : 'border-slate-300 dark:border-slate-600'}
                  `}
                >
                  {isSelected && (
...
export default function ApplicationTypeSelector({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Select Application Type</h2>
