    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Packet Review</h1>
            <p className="text-sm font-mono text-slate-500">{sessionId}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            download
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm border border-slate-300 rounded-md hover:bg-slate-50 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-5">
          ...
          <dl className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              <dt className="text-slate-500">Policies Evaluated</dt>
              <dd>{metadata.policies_evaluated ?? '-'}</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-slate-500">Policies in KB</dt>
              <dd>{metadata.policies_in_kb ?? '-'}</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-slate-500">Policies Filtered</dt>
