...
export default function WIKSClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-slate-50 to-slate-100">
      ...
      <section className="py-12 px-6 bg-gradient-to-br from-green-50 to-slate-50 dark:from-slate-800 dark:to-slate-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-8 font-['Merriweather']">
            Panel Speakers
          </h2>
          <p className="text-center text-slate-600 dark:text-slate-300 text-lg mb-4 max-w-4xl mx-auto">
          ...
          <p className="text-center text-slate-500 dark:text-slate-400 text-sm mb-12 max-w-4xl mx-auto italic">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden">
              <button
                ...
                className="w-full p-6 text-left flex items-center justify-between hover:bg-sky-50 dark:hover:bg-sky-900/20 transition-colors"
              >
                ...
                <div className="ml-4 text-2xl text-slate-500 dark:text-slate-400">
                  {expandedBios.waters ? '−' : '+'}
                </div>
              </button>
              {expandedBios.waters && (
                <div className="px-6 pb-6 border-t border-slate-200 dark:border-slate-700">
                  <div className="pt-6 space-y-4 text-slate-600 dark:text-slate-300">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
            <div className="space-y-8">
              ...
              <div className="bg-sky-50 dark:bg-sky-900/30 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-3">On the Legal Status of Water Quality Objectives</h3>
                <p className="text-slate-900 dark:text-slate-300 text-lg mb-4 font-semibold">
                  <span className="text-slate-900 dark:text-sky-300">Audience Question:</span> What are your concerns regarding the fact that the Burrard Inlet Water Quality Objectives are not legally binding?
                </p>
                <div className="mt-4 space-y-3 text-slate-900 dark:text-slate-300">
                  <p>
              ...
              <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-3">On Reflecting Indigenous Values in Standards</h3>
                <p className="text-slate-900 dark:text-slate-300 text-lg mb-4 font-semibold">
                  <span className="text-slate-900 dark:text-green-300">Moderator Question:</span> What&apos;s one key way sediment standards could better reflect Indigenous values, cultural uses, or community health needs?
                </p>
                <div className="mt-4 text-slate-900 dark:text-slate-300">
                  <p>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-3">On Challenges of Braiding Knowledge</h3>
                <p className="text-slate-900 dark:text-slate-300 text-lg mb-4 font-semibold">
                  <span className="text-slate-900 dark:text-purple-300">Moderator Question:</span> From your experience, what&apos;s a key lesson—or challenge—you&apos;ve faced when bringing Indigenous knowledge into Western scientific processes?
                </p>
                <div className="mt-4 text-slate-900 dark:text-slate-300">
                  <p>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/30 rounded-lg p-6">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-3">Final Thoughts: Landscape = Kin</h3>
                <div className="mt-4 text-slate-900 dark:text-slate-300 space-y-3">
                  <p>
          ...
          <div className="space-y-8 text-lg">
            ...
            <div>
              ...
              <a 
                ...
                className="inline-block bg-sky-700 hover:bg-sky-800 text-white font-semibold py-3 px-8 rounded-xl transition-colors duration-300 text-lg"
              >
                Email: info@sabcs.ca
              </a>
            </div>
