  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <article className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 md:p-8">
            ...
            {isAdmin && (
              <div className="mt-4 flex gap-4 items-center">
                <Link
                  ...
                  className="text-sm text-sky-700 dark:text-sky-400 hover:text-sky-800 dark:hover:text-sky-300 underline"
                >
                  Edit
                </Link>
                <DeleteButton 
          ...
          <div className="prose max-w-none">
            {document.file_url ? (
              <p className="mb-4">
                <a
                  ...
                  className="text-sky-700 dark:text-sky-400 hover:text-sky-800 dark:hover:text-sky-300 underline"
                >
                  Link to file
                </a>
              </p>
            ...
            {document.description ? (
              <div>
                <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-2">Description</h2>
                <p className="text-slate-600 dark:text-slate-300 whitespace-pre-line">{document.description}</p>
              </div>
            ) : (
