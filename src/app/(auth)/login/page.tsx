    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-sky-50 to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-sky-700 dark:text-sky-400 mb-1">SSTAC & TWG Dashboard</h2>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-100 dark:border-slate-700">
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-500 dark:text-slate-400">
              ...
              <Link href="/signup" className="text-sky-700 dark:text-sky-400 hover:text-sky-800 dark:hover:text-sky-300 font-medium transition-colors duration-200">
                Create one here
              </Link>
            </p>
          </div>
